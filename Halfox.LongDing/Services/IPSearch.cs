...
namespace Halfox.LongDing.Services
{
    ...
    public partial class IPSearch
    {
        ...
        /// <param name="ip">ip</param>
        /// <returns></returns>
        public static ha_regions SearchRegion(string ip)
        {
            ...
            {
                ha_regions regionInfo = Regions.GetRegionByNameAndLayer(country.Substring(startIndex + 1, endIndex - startIndex), 2);
                if (regionInfo != null)
                    return regionInfo;
            }
