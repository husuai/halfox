...
namespace Halfox.Core
{
    ...
    public class CreditConfigInfo : IConfigInfo
    {
        ...
        private string _rankcreditname;//消费积分名称
        private int _daymaxsendrankcredits;//每天最大发放消费积分
        private int _registerrankcredits;//注册消费积分
        private int _loginrankcredits;//每天登陆消费积分
        private int _verifyemailrankcredits;//验证邮箱消费积分
        private int _verifymobilerankcredits;//验证手机消费积分
        private int _completeuserinforankcredits;//完善用户信息消费积分
        private int _completeorderrankcredits;//完成订单消费积分(以订单金额的百分比计算)
        private int _reviewproductrankcredits;//评价商品消费积分
