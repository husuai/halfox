...
namespace Halfox.Core
{
    ...
    public class MallConfigInfo : IConfigInfo
    {
        ...
        private string _mallname = "尚格云品网上商城";//商城名称
        private string _siteurl = "http://www.shanggeyunpin.com";//网站网址
        private string _sitetitle = "尚格云品网上商城";//网站标题
        private string _seokeyword = "";//seo关键字
        private string _seodescription = "";//seo描述
        private string _icp = "鄂ICP证15023252号";//备案编号
