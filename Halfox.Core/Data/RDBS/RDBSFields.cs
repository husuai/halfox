...
namespace Halfox.Core
{
    ...
    public partial class RDBSFields
    {
        ...
        /// 积分日志表
        /// </summary>
        public const string CREDITLOGS = "[logid],[uid],[paycredits],[rankcredits],[stockcredits],[extendcredits],[payredbag],[action],[actioncode],[actiontime],[actiondes],[payrest],[rankrest],[stockrest],[extendrest],[payredbagrest],[sno],[operator]";

        /// <summary>
        /// 现金日志表
        /// </summary>
        public const string CASHLOGS = "[logid],[uid],[prepaycash],[tradecash],[comcash],[taxcash],[prepayredbag],[action],[actioncode],[actiontime],[actiondes],[prepayrest],[traderest],[comrest],[taxrest],[prepayredbagrest],[sno],[operator]";

        /// <summary>
        /// 提现日志表
        /// </summary>
        public const string ATMLOGS = "[logid],[uid],[cash],[alipay],[note],[applytime],[finishtime],[status],[sn],[operator]";
        ...
        ///  店铺图片表
        /// </summary>
        public const string STORE_IMAGES = "[simgid],[showimg],[ismain],[displayorder],[storeid]";
        ...
        /// 部分用户表
        /// </summary>
        public const string PARTUSERS = "[uid],[username],[email],[mobile],[password],[paypassword],[userrid],[storeid],[mallagid],[nickname],[avatar],[verifyemail],[verifymobile],[liftbantime],[salt],[paycredits],[rankcredits],[stockcredits],[extendcredits],[prepaycash],[tradecash],[comcash],[taxcash],[prepayredbag],[payredbag],[rankredbag],[regtype],[extendcode],[parentid],[secondid],[thirdid],[managerid],[filialeid]";
