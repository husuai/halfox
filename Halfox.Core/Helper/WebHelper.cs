...
using ThoughtWorks.QRCode.Codec;        //二维码
...
namespace Halfox.Core
{
    ...
    public class WebHelper
    {
        ...
        public static string GetRequestData(string url, string method, string postData, Encoding encoding, int timeout)
        {
            ...
            request.Method = method.Trim().ToUpper();
        ...
        /// 生成二维码
        /// </summary>
        /// <param name="name">二维码图片的文件名，如： "801000"</param>
        /// <param name="data">要生成的文字或者数字，支持中文，如： "801000" </param>
        public static void QRCodeCreate(string data,string filepath)
        {
            QRCodeCreate("Byte", "M", 4, 8, data, filepath);
        }
        ...
        /// 二维码解码
        /// </summary>
        /// <param name="filePath">图片名称</param>
        /// <returns>二维码的内容</returns>
        public static string QRDecoder(string filepath)
        {
           // string filename = name + ".jpg";
           // string filepath = HttpContext.Current.Server.MapPath(@"~\upload\qrcode") + "\\" + filename;
